...
#		method.append('touch')
	...
	cetak(nel('{sir}Menampilkan Aplikasi Akan Membuat Hasil Mudah CP , SayaTidak Menyarankan Untuk Menampilkan Aplikasi')) 
#	if _jembot_ in ['']:
#		print('➥➥➣Pilih Yang Bener Kontol ')
#		back()
...
def passwrd():
	...
	print(f'➥➥➣Hasil {k}CP{h} Tersimpan Di : {k}CP/%s {m}'%(cpc))
